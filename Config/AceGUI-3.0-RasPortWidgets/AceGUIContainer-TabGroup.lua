...
local Type, Version = "TabGroup-RasPort", 39 -- 39 backdrop
-- e
...
local function UpdateTabLook(frame)
	if frame.disabled then
		...
		-- s b
		frame.bg:Hide()
		frame:SetDisabledFontObject("GameFontDisable") -- override blizzard setting font obj in PanelTemplates_
		-- e
...
local methods = {
	...
	["CreateTab"] = function(self, id)
		...
		local tabname = ("AceGUITabGroup%dTab%d-RasPort"):format(self.num, id)
		...
		tab.normal:SetTexelSnappingBias(0.0)
		tab.normal:SetSnapToPixelGrid(false)
		tab.normal:SetPoint("TOPLEFT", tab, "TOPLEFT", -30, 0)
		tab.normal:SetPoint("BOTTOMRIGHT", tab, "BOTTOMRIGHT", 30, 0)
		tab.normal:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\button-norm")

		tab.bg = tab:CreateTexture(nil, "OVERLAY")
		if WOW_PROJECT_ID == WOW_PROJECT_CLASSIC then
			tab.bg:SetAllPoints()
		else
			tab.bg:SetTexelSnappingBias(0.0)
			tab.bg:SetSnapToPixelGrid(false)
			tab.bg:SetPoint("TOPLEFT", tab, "BOTTOMLEFT", -30, 0)
			tab.bg:SetPoint("BOTTOMRIGHT", tab, "TOPRIGHT", 30, 0)
		end
		tab.bg:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\button-highlight-gold")
		tab.bg:Hide()
	...
	["BuildTabs"] = function(self)
		...
		local PixelMult = RPUI.GetPixelMult() -- s a
...
local function Constructor()
	...
	border:SetBackdropColor(0.5, 0.5, 0.5, 1)
