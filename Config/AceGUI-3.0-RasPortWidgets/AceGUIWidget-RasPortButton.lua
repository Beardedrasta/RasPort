...
Graphical Button.
-------------------------------------------------------------------------------]]
local Type, Version = "RasPortButton", 6
...
local function Button_OnClick(frame, ...)
    ...
    -- Create and display a copy text box
...
local methods = {
    ...
    ["SetPopupText"] = function(self, text)
        self.popupText = text
    end,
...
AceGUI:RegisterWidgetType("RasPortButton", Constructor, Version)
