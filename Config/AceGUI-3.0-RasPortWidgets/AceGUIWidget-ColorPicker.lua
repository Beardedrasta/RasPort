...
local Type, Version = "ColorPicker-RasPort", 28
-- e
...
local methods = {
	...
	["SetDisabled"] = function(self, disabled)
		...
		if self.disabled then
			...
			self.colorSwatch:SetVertexColor(0.5, 0.5, 0.5) -- s a
		else
			self.frame:Enable()
...
local function Constructor()
	...
	border:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\colorpicker")

	border:SetWidth(30)
	border:SetHeight(30)
	-- e
	border:SetPoint("CENTER", colorSwatch)
	border:Show()
	...
	text:SetPoint("LEFT", colorSwatch, "RIGHT", 10, 0)
	text:SetPoint("RIGHT")
