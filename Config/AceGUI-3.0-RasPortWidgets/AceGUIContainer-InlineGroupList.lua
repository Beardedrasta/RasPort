...
-- type = "multiselect",
-- dialogControl = "InlineGroupList-RasPort",
-- image (optional)
...
-------------------------------------------------------------------------------]]
local Type, Version = "InlineGroupList-RasPort", 28
...
--[[ 	local frameBottomBorder = frame:CreateTexture(nil, "BORDER")
	...
	frameBottomBorder:SetPoint("TOPRIGHT", frame, "BOTTOMRIGHT", 0, RPUI.ACDPixelMult)
	...
	local titletext = title:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
	...
	content:SetPoint("TOPLEFT", title, "TOPRIGHT", 10, 0)
