...
local Type, Version = "EditBox-RasPort", 32 -- 29 backdrop 30 right align
-- e
...
function _G.AceGUIEditBoxInsertLink(text)
	for i = 1, AceGUI:GetWidgetCount(Type) do
		...
		local editbox = _G["AceGUI-3.0EditBox-RasPort"..i]
		-- e
...
local function Constructor()
	...
	local editbox = CreateFrame("EditBox", "AceGUI-3.0EditBox-RasPort"..num, frame, BackdropTemplateMixin and "InputBoxTemplate, BackdropTemplate" or "InputBoxTemplate")
	-- e
	...
	editbox:SetPoint("BOTTOMRIGHT", -10, 3) -- TOPLEFT done in SetLabel v30
	...
	editbox:SetBackdropColor(1, 1, 1, 0.5)
	...
	button:SetBackdropColor(1, 1, 1, 0.5)
