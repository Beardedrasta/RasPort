...
local Type, Version = "Slider-RasPort", 27 -- 24 backdrop, 25 label color white, 26 right align
-- e
...
local function Control_OnEnter(frame)
	...
	frame.Thumb:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\Thumb-highlight.tga")
end
...
local function Control_OnLeave(frame)
	...
	frame.Thumb:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\Thumb.tga")
end
...
local methods = {
	...
	["SetDisabled"] = function(self, disabled)
		...
		if disabled then
			...
			-- s b
			self.slider.Thumb:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\Thumb.tga")
			self.slider.handleLeft:SetColorTexture(0.5, 0.15, 0.15)
		end
	end,
...
local function Constructor()
	...
	local label = frame:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall") -- text color set by SetDisabled. v27 set to smaller font
	-- e
	...
	slider.bg:SetHeight(2 * RPUI.GetPixelMult())
	...
	slider.handleLeft:SetColorTexture(0.6, 0.1, 0.1)
	slider.handleLeft:SetPoint("TOPLEFT", slider.bg)
	slider.handleLeft:SetPoint("BOTTOMLEFT", slider.bg)
	slider.handleLeft:SetPoint("RIGHT", slider.Thumb, "LEFT", 2, 0)
	...
	slider.handleRight:SetPoint("LEFT", slider.Thumb, "RIGHT", -2, 0)
