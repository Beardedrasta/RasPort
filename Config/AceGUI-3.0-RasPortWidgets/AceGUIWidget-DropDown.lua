...
-- type = "multiselect",
-- dialogControl = "Dropdown-RasPort",
...
do
	...
	--]]
    local widgetType = "Dropdown-Pullout-RasPort"
    ...
    local function Constructor()
        ...
        local frame = CreateFrame("Frame", "AceGUI30Pullout-RasPort" .. count, UIParent,
        ...
        local slider = CreateFrame("Slider", "AceGUI30PulloutScrollbar-RasPort" .. count, scrollFrame,
            BackdropTemplateMixin and "BackdropTemplate" or nil)
        -- e
        ...
        slider.Thumb:SetTexture("Interface\\AddOns\\RasPort\\Media\\Button\\Thumb.tga")
        slider.Thumb:SetSize(10, 20)
        slider:SetThumbTexture(slider.Thumb)
        slider.Thumb:SetParent(slider)
        slider.Thumb:SetDrawLayer("ARTWORK")
        -- e
...
do
    ...
    local widgetType = "Dropdown-RasPort"
    ...
    local function ShowMultiText(self)
        ...
        for i, widget in self.pullout:IterateItems() do
            ...
            if widget.type == "Dropdown-Item-Toggle-RasPort" then
                -- e
    ...
    local function OnAcquire(self)
        ...
        local pullout = AceGUI:Create("Dropdown-Pullout-RasPort")
        -- e
    ...
    local function AddListItem(self, value, text, itemType)
        ...
        if not itemType then
            itemType = "Dropdown-Item-Toggle-RasPort"
        end
        -- e
    ...
    local function AddCloseButton(self)
        if not self.hasClose then
            ...
            local close = AceGUI:Create("Dropdown-Item-Execute-RasPort")
    ...
    local function Constructor()
        ...
        local dropdown = CreateFrame("Frame", "AceGUI30DropDown-RasPort" .. count, frame, BackdropTemplateMixin and
            "UIDropDownMenuTemplate, BackdropTemplate" or "UIDropDownMenuTemplate")
        -- e
        ...
        dropdown:SetPoint("BOTTOMRIGHT", -1, 3)
        dropdown:SetBackdrop({
            bgFile = "Interface\\AddOns\\RasPort\\Media\\Button\\button-norm",
            edgeFile = "Interface\\AddOns\\RasPort\\Media\\Border\\glassborder.tga",
            edgeSize = 10,
            insets = {
                left = -40,
        ...
        button:SetNormalTexture("Interface\\AddOns\\RasPort\\Media\\Config\\arrow")
        button.NormalTexture:SetSize(16, 16)
        button.NormalTexture:SetPoint("RIGHT")
        button:SetPushedTexture("Interface\\AddOns\\RasPort\\Media\\Config\\arrow") -- TODO:
        button.PushedTexture:SetSize(16, 16)
        button.PushedTexture:SetPoint("RIGHT")
        button:SetDisabledTexture("Interface\\AddOns\\RasPort\\Media\\Config\\arrowb")
