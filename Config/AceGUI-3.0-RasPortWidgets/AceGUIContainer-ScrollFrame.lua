...
local Type, Version = "ScrollFrame-RasPort", 26
-- e
...
local function Thumb_OnEnter(frame)
	frame.ThumbTexture:SetTexture([[Interface\AddOns\RasPort\Media\Button\button-norm]])
...
local function Constructor()
	...
	local scrollbar = CreateFrame("Slider", ("AceConfigDialogScrollFrame%dScrollBar-RasPort"):format(num), scrollframe, "UIPanelScrollBarTemplate")
	scrollbar:SetPoint("TOPLEFT", scrollframe, "TOPRIGHT", 4, 0)
	scrollbar:SetPoint("BOTTOMLEFT", scrollframe, "BOTTOMRIGHT", 4, 0)
	scrollbar.ScrollUpButton:Hide()
	scrollbar.ScrollDownButton:Hide()
	scrollbar.ThumbTexture:SetDrawLayer("OVERLAY")
