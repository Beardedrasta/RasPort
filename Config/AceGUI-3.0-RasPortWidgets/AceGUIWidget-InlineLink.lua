...
-- Written as part of RasPort by Treebonker
...
EditBox Widget
-------------------------------------------------------------------------------]]
local Type, Version = "Link-RasPort", 2
...
local function Constructor()
	...
	local editbox = CreateFrame("EditBox", "AceGUI-3.0EditBox-RasPort"..num, frame, BackdropTemplateMixin and "BackdropTemplate" or nil)
